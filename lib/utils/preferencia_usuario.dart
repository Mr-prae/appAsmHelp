...
class PreferenciasUsuario {
  ...
  String get primeraVez => _prefs.getString('primeraVez') ?? "";

  set primeraVez(String value) {
    _prefs.setString('primeraVez', value);
  }
  ...
  bool get complete_form_tenico =>
      _prefs.getBool('complete_form_tenico') ?? false;
